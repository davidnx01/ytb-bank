...
const FeedbackCard = ({ content, name, title, img }) => (
    <div className="flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sd:mr-5 mr-0 my-5 feedback-card">
      ...
      <div className='flex flex-row'>
        ...
        <div className="flex flex-col ml-4">
          <h4 className='font-poppins font-semibold text-[20px] leading-[33px] text-white'>{name}</h4>
